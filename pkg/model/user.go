...
func (e UserEdges) UserDataOrErr() (*UserData, error) {
	if e.loadedTypes[0] {
		if e.UserData == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: userdata.Label}
		}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldPhone, user.FieldPassword:
...
func (u *User) QueryUserData() *UserDataQuery {
	return NewUserClient(u.config).QueryUserData(u)
}

// QueryLoginLogs queries the "login_logs" edge of the User entity.
func (u *User) QueryLoginLogs() *LoginLogQuery {
	return NewUserClient(u.config).QueryLoginLogs(u)
}
