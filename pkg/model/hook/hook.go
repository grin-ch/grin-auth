...
type LoginLogFunc func(context.Context, *model.LoginLogMutation) (model.Value, error)

// Mutate calls f(ctx, m).
func (f LoginLogFunc) Mutate(ctx context.Context, m model.Mutation) (model.Value, error) {
	if mv, ok := m.(*model.LoginLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *model.LoginLogMutation", m)
}
...
type UserDataFunc func(context.Context, *model.UserDataMutation) (model.Value, error)

// Mutate calls f(ctx, m).
func (f UserDataFunc) Mutate(ctx context.Context, m model.Mutation) (model.Value, error) {
	if mv, ok := m.(*model.UserDataMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *model.UserDataMutation", m)
}
